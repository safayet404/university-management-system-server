...
class FeeInvoice extends Model
{
    ...
    protected $fillable = [
        'invoice_number', 'student_profile_id', 'fee_structure_id',
        'fee_type', 'description', 'amount', 'discount', 'fine',
        'paid_amount', 'semester', 'academic_year', 'due_date',
        'status', 'remarks',
    ];
...
{
    protected $fillable = [
        'fee_invoice_id', 'student_profile_id', 'collected_by',
        'transaction_id', 'amount', 'payment_method', 'payment_date', 'remarks',
    ];
